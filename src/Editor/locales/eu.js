tinymce.addI18n('eu', {
	...
	'Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.':
		'Ida hizki batekin hasi behar da, jarraian hizkiak, zenbakiak, gidoiak, puntuak, bi-puntu edo azpiko marrak bakarrik izan ditzake.',
	...
	'Insert link (if link plugin activated)':
		'Lotura txertatu (lotura plugina aktibatuta badago)',
	'Save (if save plugin activated)':
		'Gorde (gordetzeko plugina aktibatuta badago)',
	'Find (if searchreplace plugin activated)':
		'Bilatu (bilatuordezkatu plugina instalatuta badago)',
