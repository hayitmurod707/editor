tinymce.addI18n('it', {
	...
	'Focus to contextual toolbar':
		'Focus sulla barra degli strumenti contestuale',
	'Insert link (if link plugin activated)':
		'Inserisci link (se il plugin link \u00e8 attivato)',
	'Save (if save plugin activated)':
		'Salva (se il plugin save \u00e8 attivato)',
	'Find (if searchreplace plugin activated)':
		'Trova (se il plugin searchreplace \u00e8 attivato)',
